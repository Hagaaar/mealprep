# DIRECTIVES PLANNING REPAS — SÈCHE

## Profil
- Homme, 35 ans, 110 kg, 1m73, masse maigre ~80 kg
...
|-----------|-------|
| Calories | 2 017 kcal |
| Protéines | 170 g (2,2g × 80 kg masse maigre — JAMAIS sur poids total) |
| Glucides | 132 g (plancher absolu : 100 g/j) |
| Lipides | 90 g |

> Clause ajustement : si fatigue marquée en semaine 2 → remonter à 2 300 kcal.

## Planning entraînements
| Jour | Type |
|------|------|
| Lundi | 🚫 JEÛNE TOTAL 24h — aucun repas, aucune collation |
...
| Moment | Heure | Macros |
|--------|-------|--------|
| PRE-training | ~10h | 356 kcal · 47g G · 16g P · 10g L |
| Entraînement | ~12h | — |
| Repas midi | ~13h | 773 kcal · 65g P · 41g G · 39g L |
| POST-training (Skyr) | ~16h | 115 kcal · 24g P · 3g G · 2g L |
| Repas soir | ~19-20h | IDENTIQUE au midi — même plat, même portion |

**TOTAL : 2 017 kcal · 170g P · 132g G · 90g L**

> Règle absolue : 1 session cuisine = 2 portions identiques. Le plat du midi EST le plat du soir. Cuisiner la veille au soir, jamais le matin.

## Ustensiles autorisés (exclusivement)
- Air Fryer
- Cuiseur à riz
- Cocotte
- Tajine
...
- Budget : **50 € MAXIMUM absolu**
- Fraîcheur : protéines fraîches en début de semaine (Mar/Mer/Jeu), conserves/sec en fin de semaine (Ven/Sam/Dim)

## Exclusions absolues
- 🚫 Porc sous toutes ses formes
- 🚫 Repas ou collation le lundi
- 🚫 Dépasser 50€/semaine
