# /2ETE — Planning 2 semaines (mode canicule)
...
```
── SEMAINE XX — lun D au dim D mois 🌡️ MODE CANICULE ──
...
── SEMAINE XX+1 — lun D au dim D mois 🌡️ MODE CANICULE ──
[6 recettes salades froides]
Budget S2 : XX,XX€ / 50€
```

Vérifications silencieuses : aucune répétition sur 8 semaines · 12 recettes toutes différentes · fraîcheur · budget ≤ 50€/semaine · pas porc · glucides ≥ 100g · légumes ≥ 50% · tout se mange froid · pas de Cocotte/Tajine.

Terminer par :
> ✅ Planning 2 semaines (mode canicule) prêt. Réponds **VALIDE** pour générer.
...
`index.html` représente **la semaine N uniquement** (semaine en cours). La semaine N+1 sera affichée la semaine prochaine via `/1ETE`.
...
Message : `meal plan semaines XX-YY ETE — R1, R2, R3, R4, R5, R6 | R7, R8, R9, R10, R11, R12`
